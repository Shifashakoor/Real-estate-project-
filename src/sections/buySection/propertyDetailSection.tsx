  ...
  if (!property) {
    return (
      <Container className="py-20 text-center">
        ...
        <Link
          to="/buy"
          className="text-[#7065F0] mt-4 inline-block hover:underline font-semibold"
        >
          Go back to Buy Page
        </Link>
      </Container>
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100 p-5 md:p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#F8F9FA] p-3 rounded-xl mb-6">
          ...
          <div className="w-full md:w-auto">
            <Link
              to="/contact"
              className="flex items-center justify-center gap-2 bg-[#7065F0] text-xs font-semibold px-5 py-3 rounded-lg hover:bg-[#5b51d8] transition-all text-white shadow-sm w-full md:w-auto whitespace-nowrap"
            >
              <PhoneCall size={14} />
              Contact Us
            </Link>
