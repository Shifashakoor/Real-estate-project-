...
const BuyHeroSection = () => {
  return (
    <section className="py-16 md:py-24 font-['Plus_Jakarta_Sans',sans-serif] bg-[#F7F7FD]">
      <Container className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
        ...
        <div className="md:pr-12">
          ...
          <Heading 
            text="Find & Buy Your Dream Home with Estatery" 
            level="h1" 
            className="text-4xl md:text-5xl font-extrabold text-[#000929] mt-2 leading-tight tracking-tight"
          />
          <Paragraph 
            text="Browse through thousands of verified properties, use advanced smart filters, and connect with trusted agents easily." 
        ...
        <div className="h-80 md:h-[400px] rounded-2xl overflow-hidden shadow-md">
          <img 
            src="/home/heroSection/istockphoto-1494221275-612x612.jpg" 
            alt="Buy Hero" 
